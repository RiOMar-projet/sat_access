...
if __name__ == "__main__":
    ...
    # Load AVISO+ credentials from a CSV file (if needed for ODATIS-MR downloads)
    # The CSV file should have columns 'usrname' and 'psswrd' with the respective credentials in the first row.
    # Replace the path with the actual location of your credentials file.
    credentials_df = pd.read_csv("../pCloudDrive/Documents/info/aviso_plus_pswd.csv")
    ...
    plot_nc(
        nc_file="../data/SEXTANT/20240901-EUR-L4-SPIM-ATL-v01-fv01-OI.nc",
        bbox=[-3.5, -0.5, 44, 48],
        plot_width=5,
        plot_height=9,
        output_dir="../data/SEXTANT",
    ...
    plot_nc(
        nc_file="../data/MODIS/L3m_20200901__FRANCE_03_MOD_SST-NIGHT-NS_DAY_00.nc",
        # bbox=[-3.5, -0.5, 44, 48],
        plot_width=15,
        plot_height=12,
        output_dir="../data/MODIS",
