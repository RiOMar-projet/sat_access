...
Scatterplots for the GLOBAL results are also available for every matchup shown in the first table below. These may be accessed via the GitHub interface directly within this [folder](https://github.com/RiOMar-projet/sat_access/tree/main/validation/scatterplot).
...
(function () {
  ...
  const keyColumns = ["sensor", "correction", "processing", "zone", "source", "site", "season", "variable", "variable_sat"];
  ...
  const defaultFilterColumns = ["sensor", "correction", "processing", "zone", "source", "site", "season", "variable"];
