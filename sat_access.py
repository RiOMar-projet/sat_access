...
def download_and_plot(dl_var, dl_dates, output_dir, overwrite, plot_var, bbox):
    """
    ...
    - plot_var: Whether to plot the downloaded data.
...
if __name__ == "__main__":
    ...
    download_and_plot(args.variable, args.daterange, args.outputdir, args.overwrite, args.plot, args.boundingbox)
